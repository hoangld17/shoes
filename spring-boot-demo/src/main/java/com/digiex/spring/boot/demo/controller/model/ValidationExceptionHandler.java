...
public class ValidationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<RestAPIResponse> handleApplicationException(ApplicationException ex, WebRequest request) {
        ...
        if (ex.getApiStatus() == APIStatus.BAD_REQUEST) {
            // handle bad request
            response = responseUtil.buildResponse(APIStatus.BAD_REQUEST, ex.getMessage(), HttpStatus.MULTI_STATUS);
        } else {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
        ...
        return new ResponseEntity<Object>(new RestAPIResponse(APIStatus.BAD_REQUEST, ex.getMessage()), headers, status);
    }
    ...
    public ResponseEntity<RestAPIResponse> handleUncatchException(Exception ex, WebRequest request) {
        ...
        return responseUtil.buildResponse(APIStatus.INTERNAL_SERVER_ERROR, "Please contact System SysAdmin to resolve problem", HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        return new ResponseEntity<Object>(new RestAPIResponse(APIStatus.BAD_REQUEST, sb.toString()), headers, status);
    }
